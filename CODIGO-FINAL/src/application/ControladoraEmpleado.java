...
public class ControladoraEmpleado {
	...
	public String pedirId() {
		...
		empleado.setHeaderText("Porfavor ingresa tu Id, y digita una letra adicional al final para guardar el archivo");
		empleado.setContentText("Ingresa Tu ID y la letra");
	...
	//METODO QUE ESCRIBE UN ARCHIVO DE TEXTO
