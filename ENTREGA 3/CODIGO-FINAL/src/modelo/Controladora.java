...
public class Controladora implements General, Serializable {
	...
	// METODO PARA SERIALIZAR UN BANCO
	
	public void serial() {
		try {
			FileOutputStream obj = new FileOutputStream("Info_Bancos");
	...
	// METODO PARA DESERIALIZAR UN BANCO
	
	public void deserial() {
		try {
			FileInputStream obj = new FileInputStream("Info_Bancos");
